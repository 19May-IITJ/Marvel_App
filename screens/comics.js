...
componentDidMount() {
  fetch('http://gateway.marvel.com/v1/public/comics?ts=1&apikey=d4b1296148adc17e86c2d2acec324ac3&hash=c867cb4ebd84ccbde559d844ef2f5b2d')
  .then((application) => application.json())
  .then((applicationjson) => {
      this.setState({
         data: applicationjson.code,
         isLoading: false,
      })
           ...
           return(
            ...
            <ScrollView style = {styles.mainbackground}> 
              <View style = {{alignItems: 'center'}}>
                    <Text style = {{fontWeight:'bold', fontSize: 30}}>Marvel Comics</Text>
             </View>
